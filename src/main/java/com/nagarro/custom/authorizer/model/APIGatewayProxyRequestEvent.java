...
public class APIGatewayProxyRequestEvent implements Serializable, Cloneable {
	...
	public static class RequestIdentity implements Serializable, Cloneable {
		...
		/**
		 * @param cognitoAuthenticationType The Cognito authentication type used for
		 *                                  authentication
		 */
		...
		public boolean equals(Object obj) {
			...
			if (other.getCognitoIdentityId() == null ^ this.getCognitoIdentityId() == null)
				return false;
			if (other.getCognitoIdentityId() != null
					&& other.getCognitoIdentityId().equals(this.getCognitoIdentityId()) == false)
				return false;
			...
			if (other.getCognitoAuthenticationType() == null ^ this.getCognitoAuthenticationType() == null)
				return false;
			if (other.getCognitoAuthenticationType() != null
					&& other.getCognitoAuthenticationType().equals(this.getCognitoAuthenticationType()) == false)
				return false;
			if (other.getCognitoAuthenticationProvider() == null ^ this.getCognitoAuthenticationProvider() == null)
				return false;
			if (other.getCognitoAuthenticationProvider() != null && other.getCognitoAuthenticationProvider()
					.equals(this.getCognitoAuthenticationProvider()) == false)
				return false;
		...
		public int hashCode() {
			...
			hashCode = prime * hashCode
					+ ((getCognitoAuthenticationType() == null) ? 0 : getCognitoAuthenticationType().hashCode());
			hashCode = prime * hashCode + ((getCognitoAuthenticationProvider() == null) ? 0
					: getCognitoAuthenticationProvider().hashCode());
	...
	/**
	 * @param queryStringParameters The query string parameters that were part of
	 *                              the request
	 */
	...
	/**
	 * @deprecated Because of typo in method's name, use
	 *             {@link #withQueryStringParameters} instead.
	 */
	@Deprecated
	...
	/**
	 * @param multiValueQueryStringParameters The multi value query string
	 *                                        parameters that were part of the
	 *                                        request
	 */
	...
	/**
	 * @deprecated Because of typo in method's name, use {@link #withPathParameters}
	 *             instead.
	 */
	@Deprecated
	...
	/**
	 * @param stageVariables The stage variables defined for the stage in API
	 *                       Gateway
	 */
	...
	public String toString() {
		...
		if (getMultiValueQueryStringParameters() != null)
			sb.append("multiValueQueryStringParameters: ").append(getMultiValueQueryStringParameters().toString())
					.append(",");
	...
	public boolean equals(Object obj) {
		...
		if (other.getQueryStringParameters() == null ^ this.getQueryStringParameters() == null)
			return false;
		if (other.getQueryStringParameters() != null
				&& other.getQueryStringParameters().equals(this.getQueryStringParameters()) == false)
			return false;
		if (other.getMultiValueQueryStringParameters() == null ^ this.getMultiValueQueryStringParameters() == null)
			return false;
		if (other.getMultiValueQueryStringParameters() != null && other.getMultiValueQueryStringParameters()
				.equals(this.getMultiValueQueryStringParameters()) == false)
			return false;
	...
	public int hashCode() {
		...
		hashCode = prime * hashCode
				+ ((getQueryStringParameters() == null) ? 0 : getQueryStringParameters().hashCode());
		hashCode = prime * hashCode + ((getMultiValueQueryStringParameters() == null) ? 0
				: getMultiValueQueryStringParameters().hashCode());
